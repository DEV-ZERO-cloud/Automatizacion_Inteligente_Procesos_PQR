...
const menuItems = [
  ...
  { path: '/gestion-pqrs', icon: 'assignment', label: 'Gestión de PQRs', roles: ['operador'] },
  { path: '/bandeja-supervisor', icon: 'view_kanban', label: 'Gestión PQR', roles: ['admin', 'supervisor', 'operador'] },
  { path: '/mis-pqrs', icon: 'folder', label: 'Mis PQRs', roles: ['usuario'] },
  { path: '/bandeja-entrada', icon: 'inbox', label: 'Validar Clasificaciones', roles: ['operador'] },
  ...
  { path: '/gestion-ia', icon: 'psychology', label: 'Gestión IA', roles: ['agente'] },
];
